...
Sketch **Processing 4** pour générer une **trame vectorielle** (lignes) à partir d’une image, avec prévisualisation et **export SVG** adaptés à la gravure / au traceur (Inkscape, AxiDraw, Bantam, etc.).
